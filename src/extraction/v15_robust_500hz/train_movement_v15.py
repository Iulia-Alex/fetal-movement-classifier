...
Dataset (movement_dataset_v15.py = movement_dataset_paper.py):
  - scipy.signal.decimate 1000→500 Hz cu anti-aliasing
  - STFT natural 128×128 (n_fft=256, hop=15, win=100)
  - Drop last freq bin (129→128)
"""
...
MODEL_SAVE_PATH = '../models/movement_CUNet_v15_paper.pth'
HISTORY_PATH    = '../models/movement_CUNet_v15_paper_history.json'
LOG_DIR         = '../logs'
...
def main():
    ...
    log_path = os.path.join(LOG_DIR, 'movement_CUNet_v15_paper.log')
    import sys as _sys
